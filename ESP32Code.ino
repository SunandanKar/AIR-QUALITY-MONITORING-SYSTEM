...
void parseInputString() {
  Serial.println("Parsing input string: " + inputString);

  int tIndex = inputString.indexOf("Temp:");
  int hIndex = inputString.indexOf("Humidity:");
  int m135Index = inputString.indexOf("AQI (MQ135):");
  int m4Index = inputString.indexOf("Methane (MQ4 ppm):");
  ...
  tempData = inputString.substring(tIndex + 5, hIndex);
  tempData.trim();
  tempData.replace("°C", "");
  tempData.replace("°", "");
  tempData.replace(",", "");
  ...
  humData = inputString.substring(hIndex + 8, m135Index);
  humData.trim();
  humData.replace("%", "");
  humData.replace(",", "");
  humData.replace(":", "");
  ...
  mq135Data = inputString.substring(m135Index + 11, m4Index);
  mq135Data.trim();
  mq135Data.replace(",", "");
  mq135Data.replace(":", "");
  if (mq135Data.length() == 0) mq135Data = "N/A";

  mq4Data = inputString.substring(m4Index + 17);
  mq4Data.trim();
  mq4Data.replace(",", "");
  mq4Data.replace(":", "");
...
String generateDataTable() {
  ...
  table += "<thead><tr>";
  table += "<th>Time</th><th>AQI</th><th>Status</th><th>Temp (&deg;C)</th><th>Humidity (%)</th><th>Methane (ppm)</th><th>PM10</th><th>PM2.5</th>";
      ...
      "<div class='credits'>"
        ...
        "<div class='team'>"
          ...
          "<div class='team-member'>"
            ...
            "<div class='role'>Network Analyst</div>"
            "<div class='role'>Database Management</div>"
          "</div>"
          "<div class='team-member'>"
